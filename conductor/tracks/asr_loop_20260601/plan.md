...
- [ ] Task: Create `volume-processor.js` (AudioWorklet) for volume thresholding and silence detection.
- [ ] Task: Implement message passing to send "speech_start" and "speech_end" events to the main thread.
